...
public class UserRepositoryTest {
    ...
    void whenFindAllFriendsThenGetAllEntities() {
        ...
        Friendship friendship1 = Friendship.builder().userHolder(userThree)
                .userEmitter(userOne).created(now).build();
        Friendship friendship2 = Friendship.builder().userHolder(userThree)
                .userEmitter(userTwo).created(now).build();
        Friendship friendship3 = Friendship.builder().userHolder(userFive)
                .userEmitter(userThree).created(now).build();
        Friendship friendship4 = Friendship.builder().userHolder(userFive)
                .userEmitter(userFour).created(now).build();
        ...
        Collection<User> listOfUserThree = List.of(friendship2, friendship1).stream()
                .map(Friendship::getUserEmitter).toList();
